  ...
  return (
    ...
    <Card className="relative mx-auto w-full pt-0 overflow-hidden h-auto min-h-[395px] pb-4" data-aos='fade-up' >
      <img
        src={details?.cover}
        alt="Xatolik...."
        className={"relative z-20 w-full h-65 object-cover object-top hover:scale-105 transition-all duration-1000"}
      />
      <CardHeader>
        <CardAction>
          <Badge variant="secondary" className="duration-0">{details?.publishedAt}</Badge>
        </CardAction>
        <CardTitle className="leading-[110%]">{details?.title}</CardTitle>
      ...
      <CardFooter className="w-full flex items-center justify-end gap-2 lg:ml-auto lg:max-w-[425px] mt-auto flex-wrap xl:flex-nowrap" >
        ...
        <Button className="cursor-pointer duration-0 w-full flex-1 lg:flex-none md:w-auto" variant="outline">
